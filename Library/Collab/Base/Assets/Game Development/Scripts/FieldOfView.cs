...
public class FieldOfView : MonoBehaviour
{
	...
	[Header("Behavior")]
	[Range(0.0f, 2.0f)]
	[SerializeField] private float		_checkPlayerDelay;
	...
	private WaitForSeconds m_checkPlayerDelay;
	...
	void Start()
	{
        ...
        _viewMeshFilter.mesh = m_viewMesh;

		m_checkPlayerDelay = new WaitForSeconds(_checkPlayerDelay);

		StartCoroutine(FindTargetsWithDelay(m_checkPlayerDelay));
	}


	IEnumerator FindTargetsWithDelay(WaitForSeconds delay)
	{
		while (true)
		{
			yield return delay;
